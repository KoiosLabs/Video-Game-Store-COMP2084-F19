...
namespace Video_Game_Store_COMP2084_F19.Data.Migrations
{
    ...
    [Migration("20190918203354_Seed Data And create tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Video_Game_Store_COMP2084_F19.Models.Developer", b =>
                {
            ...
            modelBuilder.Entity("Video_Game_Store_COMP2084_F19.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Video_Game_Store_COMP2084_F19.Models.Genre", b =>
                {
                    b.Property<int>("GenreId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Video_Game_Store_COMP2084_F19.Models.Game", b =>
                {
                    b.HasOne("Video_Game_Store_COMP2084_F19.Models.Developer", "Dev")
                        .WithMany("Games")
                        .HasForeignKey("DeveloperId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Video_Game_Store_COMP2084_F19.Models.Genre", "GameGenre")
                        .WithMany("Games")
